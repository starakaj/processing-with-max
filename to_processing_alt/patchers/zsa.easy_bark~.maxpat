...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 189.0, 556.0, 48.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 111.0, 356.0, 20.0 ],
					"style" : "",
					"text" : "prepend script replace pfft newex 0 0 200 12 pfft~ zsa.abs_bark~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 270.0, 81.0, 114.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					"comment" : "(list) Bark Coefficients",
					"id" : "obj-2",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 209.0, 25.0, 25.0 ],
					"style" : "",
					"varname" : "out"
				}
